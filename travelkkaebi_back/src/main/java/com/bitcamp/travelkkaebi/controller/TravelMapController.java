...
public class TravelMapController {
    ...
    public ResponseEntity<List> selectAll(@RequestBody TravelMapDTO travelMapDTO){
        try{
    ...
    @PostMapping("/insert")
    public ResponseEntity<TravelMapDTO> insert(@RequestBody TravelMapDTO travelMapDTO,
    ...
    @PutMapping("/update")
    public ResponseEntity<TravelMapDTO> update(@RequestBody TravelMapDTO travelMapDTO,
                                               @AuthenticationPrincipal String userId){
        try{
    ...
    public ResponseEntity<Integer> delete(@RequestBody int travelMapId,
                                          @AuthenticationPrincipal String userId){
        try{
