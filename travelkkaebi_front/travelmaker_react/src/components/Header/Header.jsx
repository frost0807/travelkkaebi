...
const Logo = styled.img` // 로고 이미지
    width: 100px;
    height: 114px;
    margin-right: 30px;
`;

function Header() { // 헤더 펑션
      ...
      <Container>
        ...
        <Navbar.Collapse id="basic-navbar-nav">
          <Nav>
            ...
            */}
            {
              logInStatus === false ? <Nav.Link href="MyProfile">깨비자리</Nav.Link> : <Nav.Link href="MyProfile">프사 자리</Nav.Link>
            }
